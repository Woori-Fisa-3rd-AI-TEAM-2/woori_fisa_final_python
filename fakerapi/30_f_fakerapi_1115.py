...
def generate_expense_data(num_records=20000):
    ...
    # 연간 목표 총액 설정
    annual_target = 27_800_000 # - 30대 : 27,800,000   ( 중위값) 월: 2,316,666

    
    # 정기 결제 항목 정의
    subscriptions = {
        'Cafe': {'amount': 80000, 'interval': 30, 'category': '02', 'category_name': '카페/디저트'},  # 4000원 * 4회 * 4주
        ...
        'KT': {'amount': 65000, 'interval': 30, 'category': '10', 'category_name': '통신'}, # 통신 65000
